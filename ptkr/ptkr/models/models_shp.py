...
db = Pg(dbname='gis-ptkr', user='postgres', password='12345678', host='localhost', port='5433')
...
conn_str = 'postgresql://postgres:12345678@localhost:5433/gis-ptkr'
...
def publish_date(sender, instance, created, **kwargs):
    ...
    try:
        geo.create_featurestore(store_name=name, workspace='gis-ptkr', db='gis-ptkr', host='localhost', 
                                pg_user='postgres', pg_password='12345678', schema='data', port=5433)
        geo.publish_featurestore(workspace='gis-ptkr', store_name=name, pg_table=name)
        geo.create_outline_featurestyle('gis-ptkr_shp', workspace='gis-ptkr')
        geo.publish_style(layer_name=name, style_name='gis-ptkr_shp', workspace='gis-ptkr')
    except Exception as e:
        print(e)
...
def delete_date(sender, instance, **kwargs):
    ...
    geo.delete_layer(instance.name, 'gis-ptkr')
    geo.delete_featurestore(instance.name, 'gis-ptkr')